...
export const PERM_LABELS = {
  ...
  can_trash_view:        "View",
  can_trash_log:         "Log",
  can_trash_restore:     "Restore",
  can_trash_delete:      "Delete",
  can_export:            "Export",
...
export const MODULE_PERM_CONFIG = {
  ...
  org_chart:               ["can_view"],
  sop:                     ["can_view"],
  departments:             ["can_view", "can_add", "can_edit", "can_delete", "can_bulk_upload", "can_export"],
  teams:                   ["can_view", "can_add", "can_edit", "can_delete", "can_bulk_upload", "can_export"],
  divisions:               ["can_view", "can_add", "can_edit", "can_delete", "can_bulk_upload", "can_export"],
  grades:                  ["can_view", "can_add", "can_edit", "can_delete", "can_bulk_upload", "can_export"],
  designations:            ["can_view", "can_add", "can_edit", "can_delete", "can_bulk_upload", "can_export"],
  employees:               ["can_view", "can_add", "can_edit", "can_delete", "can_bulk_upload", "can_export"],
  ...
  payments_track:          ["can_view", "can_add", "can_edit", "can_delete", "can_export", "can_bulk_upload"],
...
export const MODULE_BUILT_STATUS = {
  ...
  master_data_orders: true, master_data_intakes: true, master_data_clauses: true, master_data_finance: true,
  dashboard: true, view_3d: true,
  intake: true, order: true,
  historical_data: true,
  company_list: true, vendor_list: true, uom: true,
  category_list: true, item_list: true,
  term_condition: true, payment_terms: true, government_laws: true,
  loa: true, boq: true, drawings: true, ra_bills: true,
  site_expense: true, petty_cash: true, bills_docs: true, payment_request: true, payments_track: true,
...
export const MODULE_SECTIONS = [
  ...
  },
  {
    ...
    groups: [
      ...
      { label: "Master Data",       keys: ["master_data_vendor","master_data_products","master_data_orders_tab","master_data_intakes","master_data_clauses","master_data_finance"] },
      { label: "Historical Data", keys: ["historical_data"], single: true },
      { label: "Organisation", keys: ["company_list","structure","org_chart","sop","policy","departments","teams","divisions","grades","designations","employees","locations"] },
